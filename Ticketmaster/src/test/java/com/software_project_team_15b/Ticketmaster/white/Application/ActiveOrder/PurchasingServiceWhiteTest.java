...
public class PurchasingServiceWhiteTest {
    ...
    @Test
    public void issueTickets_validOrder_returnsIssuedTicketIdsFromProvider() throws Throwable {
        UUID userId = UUID.randomUUID();
        ...
        when(ticketProvider.issueTickets(userId, eventId, areaId, Set.of(seatId)))
        ...
        verify(ticketProvider).issueTickets(userId, eventId, areaId, Set.of(seatId));
    }
