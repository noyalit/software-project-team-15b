...
public class PurchasingServiceWhiteTest {
        ...
        public void holdSeatsForActiveOrder_nullOrEmpty_throws() {
                assertThrows(IllegalArgumentException.class,
                                () -> callPrivate("holdSeatsForActiveOrder", new Class[] { ActiveOrder.class },
                                                (Object) null));
        ...
        public void syncOrderSeatsAvailability_nullOrEmpty_behaviour() throws Throwable {
                assertThrows(IllegalArgumentException.class,
                                () -> callPrivate("syncOrderSeatsAvailability", new Class[] { ActiveOrder.class },
                                                (Object) null));
                ...
                Object result = callPrivate("syncOrderSeatsAvailability", new Class[] { ActiveOrder.class },
                                activeOrder);
        ...
        public void requireRemoveOrAddSeatsFromActiveOrderCommand_nullOrMissingOrderId_throws() {
                ...
                RemoveOrAddSeatsFromActiveOrderCommand cmd = new RemoveOrAddSeatsFromActiveOrderCommand(null,
        ...
        @Test
        public void issueTickets_validStandingOrder_returnsIssuedTicketIdsFromProvider() throws Throwable {
                UUID userId = UUID.randomUUID();
                ...
                Map<UUID, String> issuedTicketIds = Map.of(seatId, "TICKET-1");
        ...
        public void completeCheckoutForGuest_rejectsNonGuest() {
                ...
                assertThrows(IllegalStateException.class, () -> service.completeCheckoutForGuest(
                                token,
                                UUID.randomUUID(),
